...
<head>
  ...
  <title>Loft 1325 Mobile Template 10 · Terracotta Riviera</title>
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Italiana&family=Sora:wght@400;500;600&display=swap" rel="stylesheet" />
  <link rel="stylesheet" href="/mobile-templates/assets/template-10.css" />
</head>
<body>
  <main class="mobile-shell theme-terracotta">
    ...
    <section class="meta" aria-label="Adresse">
      ...
      <p class="tagline">Résidence privée · 22 lofts · Cercle social</p>
    </section>
    ...
    <section class="signature" aria-label="Signature">
      <div class="divider"></div>
      <p>
        Teintes chaudes, conversations feutrées, art de vivre discret. L'adresse
        intime de la vieille ville.
      </p>
      <div class="divider"></div>
    </section>
  </main>
