...
<head>
  ...
  <title>Loft 1325 Mobile Template 9 · Slate Modernist</title>
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Libre+Baskerville:wght@400;700&family=Space+Grotesk:wght@400;500;600&display=swap" rel="stylesheet" />
  <link rel="stylesheet" href="/mobile-templates/assets/template-9.css" />
</head>
<body>
  <main class="mobile-shell theme-slate">
    ...
    <section class="meta" aria-label="Adresse">
      ...
      <p class="tagline">Résidence privée · 22 lofts · Design architectural</p>
    </section>
    ...
    <section class="signature" aria-label="Signature">
      <div class="divider"></div>
      <p>
        Volumes clairs, lignes calmes, gestes mesurés. Une résidence conçue comme un
        atelier privé.
      </p>
      <div class="divider"></div>
    </section>
